...
export function getValidationEditTargetForMessage(message: ValidationMessage): ValidationEditTarget | null {
  switch (message.code) {
    case "VAL-010":
      return { fieldKey: "Phase", label: "Edytuj fazę" };
    case "VAL-012":
      return getRcboEditTarget(message);
    case "VAL-015":
    case "VAL-017":
      return { fieldKey: "CableCrossSection", label: "Edytuj przekrój" };
    case "VAL-016":
      return { fieldKey: "CableLength", label: "Edytuj długość" };
    case "VAL-018":
      return { fieldKey: "CircuitName", label: "Edytuj nazwę" };
    case "VAL-019":
      return { fieldKey: "Location", label: "Edytuj lokalizację" };
    case "VAL-020":
      return { fieldKey: "PowerW", label: "Edytuj moc" };
    case "VAL-021":
      return { fieldKey: "ProtectionType", label: "Edytuj zabezpieczenie" };
    default:
      return null;
  }
}
