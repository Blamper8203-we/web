...
const currentModuleEntries: ModuleEntry[] = [
  ...
  {
    templateId: "mcb-1p-new-svg",
    code: "MCB 1P",
    label: "Rozłącznik nadprądowy MCB 1P",
    type: "MCB",
    category: "MCB",
    deviceKind: "mcb",
    phase: "L1",
    modules: 1,
    moduleRef: "MCB/rozłącznik nadprądowy MCB 1P.svg",
    protectionType: "B16",
    powerW: 2300,
  },
  {
    templateId: "mcb-2p-new-svg",
    code: "MCB 2P",
  ...
  },
  {
    ...
    code: "Blok rozdzielczy 7 pin",
    label: "Blok rozdzielczy 7 pin",
    type: "Blok rozdzielczy",
    category: "Blok rozdzielczy",
    deviceKind: "terminalBlock",
    phase: "L1+L2+L3",
