...
// `DinRailCanvas.tsx`. Those guards silently no-op'd the core "place a module
...
import sourceCode from "./DinRailCanvas.tsx?raw";

describe("DinRailCanvas mobile drag-drop regression", () => {
