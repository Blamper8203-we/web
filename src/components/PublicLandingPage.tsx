    ...
    <main className="landing">
      <section className="landing__hero">
        <div className="landing__hero-content">
          ...
          <div className="landing__warning">
            ...
            <span>
              <strong>Uwaga!</strong> Aplikacja znajduje się w fazie testów i może zawierać błędy.<br />
              Prosimy o weryfikację wygenerowanych danych.
            </span>
          </div>
        ...
        <div className="landing__hero-cta">
          <button className="landing__button--huge" onClick={onOpenNewProject}>
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
            Nowy projekt
          </button>
        </div>
      </section>
      ...
      <footer className="landing__footer">
        <div className="landing__footer-content">
          ...
          <a className="landing__button landing__button--secondary" href="mailto:dinboard2026@gmail.com?subject=[DINBoard]%20Sugestia%20lub%20Zgłoszenie">
