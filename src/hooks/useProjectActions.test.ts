...
function createMockMetadata(overrides?: Partial<ProjectMetadata>): ProjectMetadata {
  return {
    ...
    measurementProtocolStyle: "separate",
    measurementProtocols: {
      continuityHeader: { headerTitle: "", headerSubtitle: "", measurementDate: "", objectName: "" },
      loopHeader: { headerTitle: "", headerSubtitle: "", measurementDate: "", objectName: "" },
      insulationHeader: { headerTitle: "", headerSubtitle: "", measurementDate: "", objectName: "" },
